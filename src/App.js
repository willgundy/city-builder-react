...
function App() {
  ...
  const [cityName, setCityName] = useState('Atlantis');
  // finally, you'll need an array of slogans, which could start out as ['The City of Excellence'] for example
  const [citySlogans, setCitySlogans] = useState(['The City of Excellence']);
  ...
  return (
    <div className="App">
      ...
      <div className='bottom'>
        ...
        <SloganForm setCitySlogans={setCitySlogans} citySlogans={citySlogans}/>
